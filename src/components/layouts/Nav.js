        ...
        <nav ref={Nav} className={`navbar navbar-expand-lg sticky-top ${navScroll ? 'shadow' : 'inherit'} ${notHome ? 'navColorBlack' : 'inherit'}`}>
            ...
            <div ref={NavUL} className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className='navbar-nav mr-auto'>
                    <li className="nav-item mr-4 active" data-toggle="collapse" data-target="#navbarSupportedContent">
                        <Link className="nav-link" to='/'>Home <span className="sr-only">(current)</span></Link>
                    </li>
                    <li className="nav-item mr-4" data-toggle="collapse" data-target="#navbarSupportedContent">
                    ...
                    <li className="nav-item mr-4 dropdown">
                        ...
                        <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <Link className="dropdown-item" to='/floracity' data-toggle="collapse" data-target="#navbarSupportedContent">Floracity</Link>
