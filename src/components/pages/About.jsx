    ...
    return (
      ...
      <section className="about-section">
        <div className="anim-icons full-width">
          <span className="icon icon-circle-blue wow fadeIn animated animated" style={{visibility: 'visible', animationName: 'fa-spin'}} />
          <span className="icon icon-dots wow fadeInleft animated animated" style={{visibility: 'visible'}} />
          <span className="icon icon-circle-1 wow zoomIn animated animated" style={{visibility: 'visible', animationName: 'zoomIn'}} />
        </div>
        <div className="auto-container">
          <div className="row">
            {/* Content Column */}
            <div className="content-column col-lg-6 col-md-12 col-sm-12">
              <div className="inner-column">
                <div className="sec-title">
                  ...
                  <div className="text">
                  FloraHomes Global Consult Limited is a property verification and real estate investment company with a mission to prevent real estate losses. Our team of professionals includes; Land Surveyors, Estate Surveyors, Town Planners, Quantity Surveyors, Architects, Civil Engineers, Property Lawyers, Researchers, etc 

                  </div>
                  <div className="text">
                  We provide specialized real estate and property development services including Verification, Negotiation, Property Purchase, Documentation, Survey, Valuation, Architectural Design, Building Construction, Property Management, Advisory, Real Estate Investment Management as well as sales of its Estate properties throughout Nigeria.
RC number 1536444
 </div>
            ...
            <div className="image-column col-lg-6 col-md-12 col-sm-12 mt-5 pt-5 d-none d-sm-block">
              <div className="image-box">
                <figure className="image wow fadeIn animated animated" style={{visibility: 'visible', animationName: 'fadeIn'}}><img src={workers} alt="" /></figure>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-5 my-5">
        <div className="auto-container">
          <div className="content-box text-center">
            <h2 className="" style={{color:"#541484"}}>Our Vision</h2>
            <div className="text " style={{color:"#541484"}}>The Focal Point of Secure, Sterling &amp; Seamless services in Real Estate and Property
              development.</div>
          </div>
        </div>
      </section>
