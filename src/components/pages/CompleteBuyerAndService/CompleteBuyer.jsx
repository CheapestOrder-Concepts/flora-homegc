        ...
        >
          ...
          <div className="heading-paragraph">
            ...
            <p>
              ...
              documents the right way so as to secure your property at 100% and
              to prevent any likelihood of future disputes, government
              claimants, demolition, penal fees etc
            </p>
          </div>
        </div>
      </section>
          ...
          <div className=" content-column col-lg-12">
            ...
            <ul className="list-style-decimal">
              <li>
                ...
                your property at 100% done for you whether you are an
                individual, developer company or corporate investors.
              </li>
              <li>
                When you allow us to carry out the 7 property purchase stages:
                Sourcing, Verification, Valuation, Negotiation, Payment, Survey,
                and Documentation… 100% on your behalf, you have our assurance
                for the next 50 years. And, if there is any matter that arises
                after our delivery between this period. We would refund your
                investment capital.
              </li>
              <li>
                <div
