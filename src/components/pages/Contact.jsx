            ...
            <div className="contact-column col-lg-4 col-md-12 col-sm-12 order-2">
              <div className="inner-column">
                ...
                <ul className="social-icon-two social-icon-colored">
                  <li><a href="https://www.facebook.com/florahomesgc" target="_blank"><i className="fab fa-facebook-f" /></a></li>
                  <li><a href="https://www.twitter.com/florahomesgc" target="_blank"><i className="fab fa-twitter" /></a></li>
                  <li><a href="https://www.instagram.com/florahomesgc" target="_blank"><i className="fab fa-instagram" /></a></li>
                  <li><a href="https://youtube.com/channel/UCWnEctNYFxyXrzthXvsxizg" target="_blank"><i className="fab fa-youtube" /></a></li>
                  <li><a href="https://www.linkedin.com/in/florahomesgc" target="_blank"><i className="fab fa-linkedin" /></a></li>
                </ul>
              </div>
            </div>
            {/* Form Column */}
