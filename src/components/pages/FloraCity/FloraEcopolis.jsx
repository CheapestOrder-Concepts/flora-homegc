    ...
    return (
        <>
            ...
            <section className="banner-meetup">
                <div className="bg-pattern" style={{ backgroundImage: `url(${header})` }} />
                <div className="layer-outer">
                    <div className="gradient-layer" />
                </div>
                <div className="auto-container">
                    <div className="content-box">
                        <div className="address"><span className="icon fa fa-map-marker-alt" />Switch your living style to this </div>
                        <h2>
                            <font color="green">Green</font>
                            <font color="white">City</font>
                        </h2>
                        <div className="address"> with 24/7 zero-combustion electrified luxury smarthomes.  </div>
                    </div>
            ...
            <section className="welcome" style={{backgroundImage: `url(${background})`}}>
                <div className="center text-center mt-5">
                    ...
                    <div className="content p-3" >
                        ...
                        <h4 className="text-light" style={{lineHeight:"40px"}}>Be part of this <span style={{ textDecoration: "underline", fontWeight:"400",fontSize:"30px" }}> premium-secured, luxury, energy-efficient, serviced and smart </span>Ecopolis. It’s perfect for live-in, home-away-from-home relaxation, and for rentals with up to 25% annual income for Nigerians at home and in diaspora.
                        </h4>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                            <div className="inner-column">
                                <div className="sec-title">
                                    ...
                                    <h4 className="font-weight-bold">The FloraCity  is a luxury residential estate conceptualized to provide homeliness, technology, energy efficiency, class, executive security, recreation, daily needs, and social lives enhanced by community living in a natural ambiance for its occupants.</h4>

                                    <div className="text">
                                        The development is targeted for singles, young couples, parents who want a lasting legacy for their wards and who need regular income sources for children expenses, a safe haven for Nigerians residing abroad during home visits, Nigeria residents who want a home away from home, and for investors who would like to earn high yield short-let and annual rental income from the hundreds of monthly affordable luxury rental demands within our strategically targeted locations.</div>
                                </div>
                        ...
                        <div className="image-column col-lg-6 col-md-12 col-sm-12">
                            <div className="image-box">
                                <figure className="image wow fadeIn animated" style={{ visibility: 'visible', animationName: 'fadeIn' }}><img src={header} alt="Overview" /></figure>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="feature-block-three col-lg-6 col-md-12 col-sm-12">
                            <ul className="list-style-one">
                                <li>Recreation area: Private Swimming pool, Snooker, table-tennis etc.</li>
                        ...
                        <div className="feature-block-three col-lg-6 col-md-12 col-sm-12">
                            <ul className="list-style-one">
                                ...
                                <li>Fitted bathroom with modern bathtub, water heater and shower.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="subplan-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                                <div className="inner-box ">
                                    <div className="subplan-box">
                                        ...
                                        <h6 className="subplan-info">1 Bedroom Fully Finished Luxury Mini Flat</h6>
                                    ...
                                    <h6 className="subplan-desc">A finely balanced and spacious home , this mini apartment features a living room, guest wc,
                                            work area, a bedroom and a well equipped bathroom.
                                        </h6>
                            ...
                            <div className="subplan-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                                <div className="inner-box ">
                                    <div className="subplan-box">
                                        ...
                                        <h6 className="subplan-info">1 Bedroom fully finished terrace luxury Loft Apartment</h6>
                                    ...
                                    <h6 className="subplan-desc">Truly stunning to behold, this mezzanine home features a living room, guest wc, work area,  a suspended -floor bedroom and a well equipped bathroom.</h6>
                                    {/* <ul className="features ">
                                ...
                                <div className="inner">
                                    <div className="sec-title light">
                                        <div className="icon-box">
                                            ...
                                            <figure><img style={{objectFit:"contain", width:"100px"}} src={rocket} alt="" /></figure>
                                            </div>
