  ...
  return (
    <>
      <section className="banner-meetup">
        <div className="bg-pattern" style={{ backgroundImage: `url(${flora_header})` }} />
        <div className="layer-outer">
          <div className="gradient-layer" />
        </div>
        <div className="auto-container">
          <div className="content-box">
            <div className="address"><span className="icon fa fa-map-marker-alt" />Make an abode @</div>
            <h2>
          ...
          <div className="row">
            ...
            <div className="content-column col-lg-6 col-md-12 col-sm-12 order-2">
              <div className="inner-column">
                <div className="sec-title">
                  ...
                  <div className="text">The Fern Island is an unmatched residential environment visualized to combine a super luxury
                    lifestyle
                    and an Eco-friendly ambiance for home owners and residents. It is strategically located about 4 minutes drive
                    off the Lekki-Epe expressway, ibeju-lekki.</div>
                </div>
                <div className="row">
                  ...
                  <div className="about-block col-lg-6 col-md-6 col-sm-12">
                    <div className="inner-box">
                      <h4><span className="icon fa fa-map-marker-alt" /> Area</h4>
            ...
            <div className="image-column col-lg-6 col-md-12 col-sm-12">
              <div className="image-box">
                <figure className="image wow fadeIn animated" style={{ visibility: 'visible', animationName: 'fadeIn' }}><img src={fern_buiding} alt="Overview" /></figure>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="outer-box clearfix" style={{ marginLeft: '12%', marginRight: '12%', marginBottom: '10%' }}>
        {/* Content Column */}
        <div className="content-column style-two" style={{ backgroundImage: `url(${background})`}}>
          <div className="inner-column">
            ...
            <div className="text text-white ml-3 mb-3">The Layout plan covering Oju-Agbe village community Excision.</div>
            <h4 className="text-white ml-3 mb-1"><span className="icon fa fa-map" /> Plan Number</h4>
            <div className="text text-white ml-3 mb-3">LS/D/LA2934</div>
            <h4 className="text-white ml-3 mb-1"><span className="icon fa fa-arrows-alt" /> Coordinates</h4>
            <div className="text text-white ml-3 mb-3">599928.492 mE <br />716870.696 mN</div>
            <div className="btn-box ml-3"><button data-toggle="modal"  data-target="#exampleModal"   className="theme-btn btn-style-four"><span className="btn-title">Reserve Plot</span></button></div>
          </div>
        </div>
        {/* Image Column */}
        ...
        <div className="container">
          <div className="row">
            <div className="col mt-4">
              <figure className="image text-center"><img src={plot2} alt="" /></figure>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6 mt-4">
              <div className="card border border-0 rounded-0 shadow">
                <h5 className="ml-4" style={{ fontWeight: 'bold', color: '#541484' }}>LAND PRICE: NON-SERVICED PLOT</h5>
                <h6 className="ml-4" style={{ fontSize: '18px', color: '#ed6c11' }}>DEVELOPMENT</h6>
                <p className="ml-4">Road Network<br />Fencing<br />Gatehouse<br /><br /><br /></p>
                <p className="ml-4">PROMO PRICE: N7500/sqm<br />NORMAL PRICE: N8000/sqm</p>
                <h6 className="ml-4" style={{ fontSize: '18px', color: '#ed6c11' }}>OTHER FEES</h6>
            ...
            <div className="col-md-6 mt-4">
              <div className="card border border-0 rounded-0 shadow">
                <h5 className="ml-4" style={{ fontWeight: 'bold', color: '#541484' }}>LAND PRICE: SERVICED PLOT</h5>
                <h6 className="ml-4" style={{ fontSize: '18px', color: '#ed6c11' }}>DEVELOPMENT</h6>
                <p className="ml-4">All Non-Serviced Development<br />Tarred Road<br />Drainage<br />Electricity to the
                  plot<br />Survey</p>
                <p className="ml-4">PROMO PRICE: N13,000/sqm<br />NORMAL PRICE: N15,000/sqm</p>
                <h6 className="ml-4" style={{ fontSize: '18px', color: '#ed6c11' }}>OTHER FEES</h6>
          ...
          <div className="price-table">
            ...
            target="_blank"><span class="btn-title">CLICK HERE TO DOWNLOAD THE PRICE </span>  </a>
              ...
              <a href="assets/Price_table_finsland.pdf" className="theme-btn btn-style-three" target="_blank"><span className="btn-title">CLICK HERE TO DOWNLOAD THE PRICE </span></a>
            </div>
      ...
      <section className="galery-section-three" style={{ backgroundColor: '#ffffff' }}>
        <div className="auto-container">
          <div className="sec-title text-center">
            <span className="title" id="gallery-carousel" />
            <h2 style={{ color: '#476c11' }}><span style={{ color: '#ed6c11' }}>The</span> Fern Island</h2>
          </div>
      ...
      <section className="features-section-three no-pd-top">
        <div className="auto-container">
          ...
          <div className="row">
            ...
            <div className="feature-block-three col-lg-6 col-md-12 col-sm-12">
              <ul className="list-style-one">
                ...
                <li>Property is located in the fastest developing neighborhood in the whole of West Africa.</li>
                <li>Covers a land area of over 10 acres within Oju-Agbe village excision.</li>
            ...
            <div className="feature-block-three col-lg-6 col-md-12 col-sm-12">
              <ul className="list-style-one">
                ...
                <li>A potential recreation site with water front view for residents.</li>
                <li>FREE architectural 3D designs with the complete working drawing worth N1m for Outright Subscribers engaging our
                  Design, Build and Manage service.</li>
              </ul>
            </div>
          </div>
          {/* Image Block */}
          <div className="gallery-item">
            <div className="image-box">
              <figure className="image"><img src={thefernisland_features} alt="TheFernIsland Neighborhood" /></figure>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="row">
            ...
            <div className="feature-block-three col-lg-6 col-md-12 col-sm-12">
              <ul className="list-style-one">
                ...
                <li>Processing and delivering of title for individual buyers</li>
            ...
            <div className="feature-block-three col-lg-6 col-md-12 col-sm-12">
              <ul className="list-style-one">
                ...
                <li> Located beside a natural water body that flows into the lagoon.</li>
                <li> About 3 minutes drive to Lekki Free Trade Zone.</li>
                <li> About 5 minutes drive to Dangote refinery.</li>
                <li>It's right beside the proposed regional highway that link Lekki Epe
                  Express straight to LFTZ.</li>
                <li> About 3 minutes drive from the Lekki-Epe Express.</li>
                <li>Shares boundary with the Labour City.</li>
                <li> Also has a proposed road going to link the refinery/ seaport road.</li>
              </ul>
            </div>
          </div>
        </div>
                  ...
                  <div className="schedule-block">
                    <div className="inner-box">
                      <div className="inner">
                        ...
                        <div className="text">Reserve your slot and Book for either online recorded inspection or offline physical
                          inspection.</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="schedule-block even">
                    <div className="inner-box">
                      <div className="inner">
                        ...
                        <div className="text">Receive your invoice within 24 hours after form submission. If not received, please send a
                          follow up mail to hello.florahomesgc@gmail.com to confirm plot availability.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="schedule-block">
                    <div className="inner-box">
                      <div className="inner">
                        ...
                        <div className="text">Pay for reserved property according to your chosen Payment Plan above.</div>
                      </div>
                    </div>
                  </div>
                  {/* schedule Block */}
                  <div className="schedule-block even">
                    <div className="inner-box">
                      <div className="inner">
                        ...
                        <div className="text">For instalmental payment, receive Receipt, Contract of Sales and Provisional
                          Allocation Letter.
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="schedule-block">
                    <div className="inner-box">
                      <div className="inner">
                        ...
                        <div className="text">For Full payment, receive Deed of Assignments, Survey, Receipt, Allocation Letter
                  ...
                  <div className="schedule-block even">
                    <div className="inner-box">
                      <div className="inner">
                        ...
                        <div className="text">For house, handover of keys and Documents after a maximum of 12 months of full
                          payment.</div>
                      </div>
                    </div>
                  </div>
                ...
                <ul className="accordion-box">
                  ...
                  <li className="accordion block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    <div className="acc-btn" >
                      <div className="icon-outer" ><span className="icon icon-plus fa fa-angle-down" /> </div>Where is The Fern Island
                      located?
                    </div>
                    <div className="acc-content">
                      <div className="content">
                        <div className="text">It is located in Oju-Agbe, Ibeju-Lekki Lekki Epe expressway and shares a neighborhood with
                          Lekki Free Trade Zone, Dangote Refinery, Eleganza industrial city, PAN Africa University
                          etc.
                        </div>
                      </div>
                    </div>
                  ...
                  <li className="accordion block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    ...
                    <div className="acc-content">
                      <div className="content">
                        <div className="text">Oju-Agbe Village Excision. The land is confirmed to be free from government acquisition.
                        </div>
                      </div>
                    </div>
                  </li>
                  ...
                  <li className="accordion block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    <div className="acc-btn">
                      <div className="icon-outer"><span className="icon icon-plus fa fa-angle-down" /> </div>What kind of property is on
                      The Fern Island?
                    </div>
                    <div className="acc-content">
                      <div className="content">
                        <div className="text">
                          <ul>
                            ...
                            <li>Building -</li>
                            <ol>
                              <li>4 Bedroom Semi-Detached duplex (with exterior finishing)</li>
                              <li>5 Bedroom fully-Detached duplex with BQ and a standard swimming pool.</li>
                            </ol>
                          </ul>
                        </div>
                      </div>
                  ...
                  <li className="accordion block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    ...
                    <div className="acc-content">
                      <div className="content">
                        <div className="text">The developer is FloraHomes Global Consult Limited. <br />
                          Office: 32, East Lake Drive, Adiva Plainfield, Beechwood Estate, Ibeju-Lekki.
                        </div>
                      </div>
                    </div>
                  </li>
                  ...
                  <li className="accordion block active-block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    <div className="acc-btn active">
                      <div className="icon-outer"><span className="icon icon-plus fa fa-angle-down" /> </div>Is the Estate's location
                      already Habitable?
                    </div>
                    <div className="acc-content current">
                      <div className="content">
                        <div className="text">All area is already habitable for those who want to build immediately.</div>
                      </div>
                    </div>
                  </li>
                  {/*Block*/}
                  <li className="accordion block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    <div className="acc-btn">
                      <div className="icon-outer"><span className="icon icon-plus fa fa-angle-down" /> </div>Is it really an Island like
                      Banana Island?
                    </div>
                    <div className="acc-content">
                      <div className="content">
                        <div className="text">No. Though it has great potential to surpass Banana Island. <br /> The natural water body runs
                          by the side of the subject parcel.</div>
                      </div>
                    </div>
                  </li>
                  {/*Block*/}
                  <li className="accordion block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    <div className="acc-btn">
                      <div className="icon-outer"><span className="icon icon-plus fa fa-angle-down" /> </div>How much are the properties?
                    </div>
                    <div className="acc-content">
                      <div className="content">
                        <div className="text"> <a href="https://drive.google.com/file/d/1XEmuvIUdT9FynvekkjaigOsYk20V8oEj/view">CLICK HERE TO DOWNLOAD</a></div>
                      </div>
                    </div>
                  </li>
                  {/*Block*/}
                  <li className="accordion block active-block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    <div className="acc-btn active">
                      <div className="icon-outer"><span className="icon icon-plus fa fa-angle-down" /> </div>Can I Make installment
                      payments?
                    </div>
                    <div className="acc-content current">
                      <div className="content">
                        <div className="text">Yes, <a href="https://drive.google.com/file/d/1XEmuvIUdT9FynvekkjaigOsYk20V8oEj/view">CLICK HERE TO DOWNLOAD</a></div>
                      </div>
                    </div>
                  </li>
                </ul>
              ...
              <div className="inner-column">
                ...
                <ul className="accordion-box">
                  ...
                  <li className="accordion block active-block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    ...
                    <div className="acc-content current">
                      <div className="content">
                        <div className="text">No. All payment must be made only to <b>FloraHomes Global Consult Limited</b> account.
                          <br />
                          <ul>
                  ...
                  <li className="accordion block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    <div className="acc-btn">
                      <div className="icon-outer"><span className="icon icon-plus fa fa-angle-down" /> </div>What do I get after making
                      payment for Land?
                    </div>
                    <div className="acc-content">
                      <div className="content">
                        <div className="text">For installment payment, Receipt, Contract of Sale and Provisional Allocation Letter.<br />
                          For Full payment, Deed of Assignments, Survey, Receipt, Allocation Letter.
                        </div>
                      </div>
                    </div>
                  </li>
                  ...
                  <li className="accordion block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    <div className="acc-btn">
                      <div className="icon-outer"><span className="icon icon-plus fa fa-angle-down" /> </div>Are ther Other fees?
                    </div>
                    <div className="acc-content">
                      <div className="content">
                  ...
                  <li className="accordion block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    <div className="acc-btn">
                      <div className="icon-outer"><span className="icon icon-plus fa fa-angle-down" /> </div>Can I resell my property?
                    </div>
                    <div className="acc-content">
                      <div className="content">
                        <div className="text">Yes. But a written Notice of Transfer should be given to FloraHomes Global Consult Limited.
                        </div>
                      </div>
                    </div>
                  </li>
                  ...
                  <li className="accordion block wow fadeInUp animated" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                    <div className="acc-btn">
                      <div className="icon-outer"><span className="icon icon-plus fa fa-angle-down" /> </div>If I'm Unable to Balance
                      Payment Can I Get a Refund?
                    </div>
                    <div className="acc-content">
                      <div className="content">
                        <div className="text">Yes. But a minimum of 2 months notice in writing must be sent to us. <br /> <b>NB: Refund
                          attracts 20% administrative charge.</b></div>
                      </div>
                    </div>
                  </li>
                  {/*Block*/}
