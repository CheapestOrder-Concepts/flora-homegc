              ...
              <div className="auto-container">
                <div className="carousel-item active">
                  <div>
                    ...
                    <Fade bottom>
                      <h2 style={{ color: cutomTextStyle.color }}>
                        FloraHomes GC,
                      </h2>
                      <p style={{ color: cutomTextStyle.color }}>
                ...
                <div className="carousel-item">
                  <div>
                    <HeadShake>
                      <h3 style={{ color: cutomTextStyle.color }}>
              ...
              <div className="col-sm">
                ...
                <div className="word">
                  ...
                  <p>
                    ...
                    found property or for already existing property against
                    government acquisition, title issues, ownership issues,
                    Omo-Onile wahala, uses issues, dispute, third party
                    claimants, structural defects etc. This we achieve by taking
                    such properties through our systemised verification
                    checklist.
                  </p>
                </div>
              ...
              <div className="col-sm">
                ...
                <div className="word">
                  ...
                  <p>
                    ...
                    individual or corporate large expanse across Nigeria. This
                    involves supervising and executing property transactions
                    through all the 7 stages of property purchase: Sourcing,
                    Verification, Valuation, Negotiation, Payment, Survey, and
                    Documentation.
                  </p>
                </div>
            ...
            <div className="row">
              <div className="col-sm">
                ...
                <ol>
                  <li
                    className="noB"
                    style={{ listStyleType: listStyle.listStyleType }}
                  >
                    Running end-to-end property verification on every subject
                    property before you pay for them, one property at a time.
                  </li>
                  <li
                    className="noB"
                    style={{ listStyleType: listStyle.listStyleType }}
                  ...
                  <li
                    ...
                    style={{ listStyleType: listStyle.listStyleType }}
                  >
                    Making verified and futuristic properties accessible to
                    every individual and corporate investors.
                  </li>
                  <li
                    className="noB"
                    style={{ listStyleType: listStyle.listStyleType }}
