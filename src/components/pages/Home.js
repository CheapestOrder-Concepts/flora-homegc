      ...
      <div className='newP'>
              ...
              <div className='auto-container'>
                <div className='carousel-item active'>
                  <div>
                    ...
                    <Fade bottom>
                      <h2 className="text-light font-weight-bolder">FloraHomes GC,</h2>
        ...
        <div className='container con1'>
          <div className='row'>
            ...
            <div className='col-sm'>
              <h4>Why we get</h4>
              <h2 style={{color:"#1e1f36", fontWeight:"700"}}>Our hands dirty for you</h2>
              <h5 className="mb-4">
            ...
            <div className="content-column col-lg-6 col-md-12 col-sm-12">
              <div className="inner-column">
                <div className="sec-title">
                  ...
                  <h2>Our Promise To You</h2>
                  <p className="font-weight-bold mt-3" >We Help You Prevent Real Estate Losses By;</p>
                  <div className="text">
                    <ul className="list-style-two">
                      <li>Running end-to-end property verification on every subject property before you pay for them, one property at a time.</li>
                      <li>Providing 100% done-for-you real estate and property development services to existing and aspiring property investors.</li>
