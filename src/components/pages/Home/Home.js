            ...
            <div className="row">
              <div className="col-sm">
                ...
                <div className="word">
                  ...
                  <p>
                    Let us help you clear your property of interest before
                    paying for it or for already existing property against
                    government acquisition, title issues, ownership issues,
                    Omo-Onile wahala, uses issues, dispute, third party
                    claimants, structural defects etc irrespective of your
                    location and get up to <strong>50 years warranty </strong>{" "}
                    for your property. For individuals, developers or corporate
                    investors.
                  </p>
                </div>
          ...
          <div className="auto-container">
            <div className="content-box">
              ...
              <video
                id="player"
                controls
                src="https://flora-media.s3.us-east-2.amazonaws.com/home_video.mp4"
