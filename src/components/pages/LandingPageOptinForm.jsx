...
const LandingPageOptinForm = ({ showReg = true, handleClose }) => {
  ...
  const { fullName, email, phoneNumber, category,  when_to_purchase, referer } = regDetails
  ...
  return (<>
    ...
    <div class="modal fade" id="landingModal" tabindex="-1" aria-labelledby="landingModalLabel" aria-hidden="true" style={{ marginTop: "15px" }}>
...
">Individual and Group property OWNER(family, club, corporate, religious)
              ...
              <div className="form-group">
                ...
                <select name="when_you_need_us" id="when_you_need_us" value={when_to_purchase} required className="form-control">
