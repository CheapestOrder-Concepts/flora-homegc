                ...
                <div className="auto-container">
                    <div className="row">
                        ...
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                ...
                                <div className="lower-content">
                                    ...
                                    <Link className="custom-btn btn btn-lg" to="/verification">View Now</Link>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                ...
                                <div className="lower-content">
                                    ...
                                    <Link to="/cpbs" className="custom-btn btn btn-lg">View Now</Link>
                                </div>
                            </div>
                        </div>
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                <div className="image-box">
                                    <figure className="image"><Link to="/floracity"><img src={fern} alt="Floracity" /></Link></figure>
                                </div>
                                <div className="lower-content">
                                    <h4><Link to="/floracity">Floracity</Link></h4>
                                    ...
                                    <Link to="/floracity" className="custom-btn btn btn-lg">View Now</Link>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                <div className="image-box">
                                    <figure className="image"><Link to="/dbm"><img src={workers} alt="Design,Build and Manage" /></Link></figure>
                                </div>
                                <div className="lower-content">
                                    <h4><Link to="/dbm">Design, Build & Manage</Link></h4>
                                    ...
                                    <Link to ="/dbm" className="custom-btn btn btn-lg">View Now</Link>
                                </div>
                            </div>
                        </div>
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                <div className="image-box">
                                    <figure className="image"><Link to="/investment"><img src={dyi} alt="Investment Packages" /></Link></figure>
                                </div>
                                <div className="lower-content">
                                    <h4><Link to="/books">Books</Link></h4>
                                    ...
                                    <Link to ="/books" className="custom-btn btn btn-lg">View Now</Link>
                                </div>
                            </div>
                        </div>
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                <div className="image-box">
                                    <figure className="image"><Link to="/advisory"><img src={advisory} alt="advisory" /></Link></figure>
                                </div>
                                <div className="lower-content">
                                    ...
                                    <a  className="custom-btn btn btn-lg" href="https://docs.google.com/forms/d/e/1FAIpQLSc8rf7DAg4Wb4-ghqM-IVMXglwR-M_CwMjLd3d3_sdeGUaxKA/viewform" >View Now</a>
                                </div>
                            </div>
                        </div>
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                <div className="image-box">
                                    <figure className="image"><Link to="/sell-my-property"><img src={smp} alt="Sell my property" /></Link></figure>
                                </div>
                                <div className="lower-content">
                                    <h4><Link to="/sell-my-property"> Sell My Property</Link></h4>
                                    ...
                                    <Link to ="/sell-my-property" className="custom-btn btn btn-lg">View Now</Link>
                                </div>
                            </div>
                        </div>
