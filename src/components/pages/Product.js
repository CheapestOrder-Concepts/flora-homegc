                ...
                <div className="auto-container">
                    <div className="row">
                        ...
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                ...
                                <div className="lower-content">
                                    ...
                                    {/* <div className="custom-btn btn btn-lg"> */}
                                        <Link to="/verification" className="custom-btn btn btn-lg read-more">View Now</Link>
                                        {/* </div> */}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                ...
                                <div className="lower-content">
                                    ...
                                    {/* <div className="custom-btn btn btn-lg"> */}
                                        <Link to="/cpbs" className="custom-btn btn btn-lg read-more">View Now</Link>
                                        {/* </div> */}
                                </div>
                            </div>
                        </div>
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                ...
                                <div className="lower-content">
                                    ...
                                    {/* <div className="custom-btn btn btn-lg"> */}
                                        <Link to="/floracity" className="custom-btn btn btn-lg read-more">View Now</Link>
                                        {/* </div> */}
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                ...
                                <div className="lower-content">
                                    ...
                                    {/* <div className="custom-btn btn btn-lg"> */}
                                        <Link to="/dbm" className="custom-btn btn btn-lg read-more">View Now</Link>
                                        {/* </div> */}
                                </div>
                            </div>
                        </div>
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                <div className="image-box">
                                    <figure className="image"><Link to="/"><img src={dyi} alt="Investment Packages" /></Link></figure>
                                </div>
                                <div className="lower-content">
                                    ...
                                    {/* <div className="custom-btn btn btn-lg"> */}
                                        <Link to="/" className="custom-btn btn btn-lg read-more">View Now</Link>
                                        {/* </div> */}
                                </div>
                            </div>
                        </div>
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                <div className="image-box">
                                    <figure className="image"><Link to="/"><img src={advisory} alt="advisory" /></Link></figure>
                                </div>
                                <div className="lower-content">
                                    ...
                                    {/* <div className="custom-btn btn btn-lg"> */}
                                        <a href="https://docs.google.com/forms/d/e/1FAIpQLSc8rf7DAg4Wb4-ghqM-IVMXglwR-M_CwMjLd3d3_sdeGUaxKA/viewform" className="custom-btn btn btn-lg read-more">View Now</a>
                                        {/* </div> */}
                                </div>
                            </div>
                        </div>
                        <div className="news-block col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                            <div className="inner-box">
                                <div className="image-box">
                                    <figure className="image"><Link to="/"><img src={smp} alt="Sell my property" /></Link></figure>
                                </div>
                                <div className="lower-content">
