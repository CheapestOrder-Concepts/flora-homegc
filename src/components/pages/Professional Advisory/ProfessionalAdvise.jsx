      ...
      <section style={{ background: "#541484" }}>
        <div className="auto-container">
          ...
          <div className="heading-paragraph">
            <p>
              {" "}
              For any matter relating to landed properties either for the
              purpose of getting a safe and high yield profitable real estate
              related investments or to clear any subject property against
              government acquisition, title issues, ownership issues, Omo-Onile
              wahala, uses issues, dispute, third party claimants, structural
              defects etc, we affirm our capacity to objectively and
              professionally advise, guide, resolve and rectify any of these
              matters for you either you're an existing or an aspiring real
              estate investor.
            </p>
          </div>
          <div
        ...
        >
          ...
          <div className="heading-paragraph">
            <p>
              ...
              religious organizations, NGOs or corporate organisation… as long
              as the theme is real estate investments and property developments
          ...
          <div className=" content-column col-lg-12">
            ...
            <ul className="list-style-decimal">
              ...
              <li>
                ...
                Quantity Surveyors, Property Investment Banker etc will draft
                out your task roadmap for execution.
              </li>
              ...
              {/* <table className="table table-bordered table-center">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="text">10% of property fair market value.</td>
                  </tr>
                  <tr>
                    <td className="text">With Viable Structure</td>
                    <td className="text">+N50,000($135) per building</td>
